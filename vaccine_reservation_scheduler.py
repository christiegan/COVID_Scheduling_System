...
if __name__ == '__main__':
        with SqlConnectionManager(Server=os.getenv("Server"),
            ...
            jj = FillingVaccines("Johnson&Johnson", 1, 500, dbcursor)
            pf = FillingVaccines("Pfizer", 2, 500, dbcursor)

            jj.AddDoses("Johnson&Johnson", 300, dbcursor)

            # Assign patients
            VaccinePatients("Alex", "Blah2", "blah2@gmail.com", 98115, dbcursor)

            # Schedule the patients
            Appointments("Alex", "Blah2", "blah2@gmail.com", "Pfizer", dbcursor)
